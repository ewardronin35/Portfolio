...
$sql = "SELECT * FROM visitors WHERE ip_address = '$ip'";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    $sql = "UPDATE visitors SET visit_count = visit_count + 1, last_visit = NOW() WHERE ip_address = '$ip'";
} else {
...
<section id="skills" class="py-5 bg-light">
    ...
    <section id="contact" class="py-5 bg-light">
        <div class="container">
            <h2 class="section-title text-center mb-5" data-aos="fade-up">Get In Touch</h2>
    ...
    <footer class="py-4 text-center">
        <div class="container">
            <p class="mb-0">&copy; 2023 Edward. All rights reserved.</p>
        </div>
    </footer>
